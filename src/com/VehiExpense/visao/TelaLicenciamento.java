 ...
 * @author aluno
 */
public class TelaLicenciamento extends javax.swing.JFrame {

    /**
     * Creates new form TelaLicenciamento
     */
    public TelaLicenciamento() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Gastos Licenciamento");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaLicenciamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaLicenciamento().setVisible(true);
            }
        });
    }
